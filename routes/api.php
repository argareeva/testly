...
Route::name('api.')->group( function() {
    ...
    Route::get('categories', [\App\Http\Controllers\Api\CategoryController::class, 'index'] )->name('authors.index');
    Route::get('categories/{id}', [\App\Http\Controllers\Api\CategoryController::class, 'show'] )->name('authors.show');
});
